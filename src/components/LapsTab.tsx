        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6">
            {renderedLaps.length === 0 ? (
              <div className={`flex flex-col items-center justify-center py-12 ${textMut} text-center`}>
              ...
              >
                ...
                <div className={`font-heading text-3xl font-black ${textPrimary} tracking-tighter`}>
                  {lap.time}
                </div>
                
                {lap.note && (
                  <p className={`font-sans text-xs ${textSec} font-semibold mt-1.5 italic`}>
                    "{lap.note}"
                  </p>
                )}
              </div>
                ...
                >
                  <div className="flex items-center gap-3.5 mb-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className={`font-heading text-lg font-bold truncate leading-tight ${textPrimary} tracking-tight`}>
                        {timer.title}
                      </h3>
                      <p className={`font-sans text-[10px] font-black ${textMut} mt-1 uppercase tracking-wider`}>
                        {timer.type}
                      </p>
                    </div>
                  </div>
